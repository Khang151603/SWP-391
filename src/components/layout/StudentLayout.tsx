  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <div className="grid min-h-screen lg:grid-cols-[260px_1fr]">
        <aside className="flex flex-col border-b border-slate-200 bg-white px-6 py-6 lg:border-b-0 lg:border-r">
          <Link to="/" className="flex items-center gap-3">
            <div className="rounded-xl bg-blue-600 p-3 text-xl font-bold text-white">
              SC
            </div>
            <div>
              <p className="text-xs uppercase tracking-[0.28em] text-slate-500">Student Portal</p>
            ...
            <header className="flex flex-col gap-4 border-b border-slate-200 px-6 py-6 lg:flex-row lg:items-center lg:justify-between bg-white">
              ...
              <div className="flex flex-col gap-3 text-sm text-slate-600 md:flex-row md:items-center">
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm text-slate-800 placeholder:text-slate-400 focus:border-blue-400 focus:outline-none md:w-72"
                />
              </div>
            </header>
