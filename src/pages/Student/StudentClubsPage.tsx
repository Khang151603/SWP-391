...
function StudentClubsPage() {
  ...
  return (
    <StudentLayout
      title="CLB của tôi"
      subtitle="Theo dõi, quản lý và truy cập nhanh vào các câu lạc bộ bạn đang tham gia"
    >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-4 text-sm text-slate-300">
                        ...
                        <span className="flex items-center gap-1.5">
                          ...
                          <span className="font-medium text-amber-100">{club.pending}</span>
                          <span className="text-slate-400">đơn đang chờ duyệt</span>
                        </span>
                      </div>
                    </div>
                  </div>
